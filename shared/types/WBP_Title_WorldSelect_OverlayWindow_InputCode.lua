...
---@field PalEditableTextBox_111 UPalEditableTextBox
...
function UWBP_Title_WorldSelect_OverlayWindow_InputCode_C:BndEvt__WBP_Title_WorldSelect_OverlayWindow_InputCode_WBP_PalInvisibleButton_ShoiwHideInviteCode_K2Node_ComponentBoundEvent_4_CommonButtonBaseClicked__DelegateSignature(Button) end
---@param Text FText
function UWBP_Title_WorldSelect_OverlayWindow_InputCode_C:BndEvt__WBP_Title_WorldSelect_OverlayWindow_InputCode_PalEditableTextBox_111_K2Node_ComponentBoundEvent_5_OnEditableTextBoxChangedEvent__DelegateSignature(Text) end
---@param Text FText
---@param CommitMethod ETextCommit::Type
function UWBP_Title_WorldSelect_OverlayWindow_InputCode_C:BndEvt__WBP_Title_WorldSelect_OverlayWindow_InputCode_PalEditableTextBox_111_K2Node_ComponentBoundEvent_6_OnEditableTextBoxCommittedEvent__DelegateSignature(Text, CommitMethod) end
