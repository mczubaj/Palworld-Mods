...
function UBP_PalClimbingComponent_C:UpdateClimbBuff() end
---@param IsHit boolean
---@param OutActors TArray<AActor>
function UBP_PalClimbingComponent_C:FindLadder(IsHit, OutActors) end
---@param Result boolean
function UBP_PalClimbingComponent_C:CanClimbingStart(Result) end
---@return boolean
function UBP_PalClimbingComponent_C:TryClimbAfterGrappling() end
function UBP_PalClimbingComponent_C:RayCollisionCheckEndExtrusion() end
...
function UBP_PalClimbingComponent_C:CenterRayCast(IsHit, HitPos, OutHit) end
---@param StartPos FVector
---@param EndPos FVector
---@param IsHit boolean
---@param HitResult FHitResult
