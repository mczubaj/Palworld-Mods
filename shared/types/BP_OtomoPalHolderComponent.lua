...
---@field DisableOtomoCollision boolean
UBP_OtomoPalHolderComponent_C = {}

---@param Class TSubclassOf<AAIController>
function UBP_OtomoPalHolderComponent_C:GetAIClass(Class) end
function UBP_OtomoPalHolderComponent_C:InactivateAllOtomo() end
---@param Handle UPalIndividualCharacterHandle
---@param Transform FTransform
---@param Transform_Location FVector
---@param Transform_Rotation FRotator
---@param Transform_Scale FVector
---@param KeepActigvateOtomoId boolean
function UBP_OtomoPalHolderComponent_C:ActivatePalByHandle(Handle, Transform, Transform_Location, Transform_Rotation, Transform_Scale, KeepActigvateOtomoId) end
---@param Otomo AActor
...
---@param IsDelayAddReserver boolean
---@param IsSuccess boolean
UBP_OtomoPalHolderComponent_C['Inactivate Otomo By Handle'] = function(IndividualHandle, IsDelayAddReserver, IsSuccess) end
---@param IsSuccess boolean
...
---@param ID FPalInstanceID
UBP_OtomoPalHolderComponent_C['Spawn Character Callback'] = function(ID) end
---@param SlotID int32
...
function UBP_OtomoPalHolderComponent_C:DelayAddOtomoForReserverList(Otomo, IsDelay) end
---@param DeadInfo FPalDeadInfo
function UBP_OtomoPalHolderComponent_C:OnOtomoDeath_ToAll(DeadInfo) end
---@param DeadInfo FPalDeadInfo
function UBP_OtomoPalHolderComponent_C:DIsplayOtomoDeathLog(DeadInfo) end
---@param ballTransform FTransform
---@param hitTarget AActor
function UBP_OtomoPalHolderComponent_C:ActivateCurrentOtomoFromBallNative(ballTransform, hitTarget) end
