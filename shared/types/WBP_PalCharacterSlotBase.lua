...
---@field OnChangedAssignToExpedition FWBP_PalCharacterSlotBase_COnChangedAssignToExpedition
UWBP_PalCharacterSlotBase_C = {}

function UWBP_PalCharacterSlotBase_C:OnChangedAssingToExpedition_Internal() end
...
---@param individualParam FPalInstanceID
function UWBP_PalCharacterSlotBase_C:SetupByIndividualId(individualParam) end
...
function UWBP_PalCharacterSlotBase_C:OnChangedAssignToExpedition__DelegateSignature(bIsAssigned) end
