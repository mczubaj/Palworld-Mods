...
---@field WBP_Title_MenuButton_EULA UWBP_Title_MenuButton_C
...
function UWBP_TitleMenu_C:UpdateUserName() end
...
function UWBP_TitleMenu_C:BndEvt__WBP_TitleMenu_WBP_Title_MenuButton_EULA_K2Node_ComponentBoundEvent_6_OnClicked__DelegateSignature() end
