...
---@return boolean
function UBP_CoopSkillSearchEffectController_C:IsFadingOut() end
---@return boolean
...
function UBP_CoopSkillSearchEffectController_C:ProcStart(EffectParam) end
---@param DeltaTime double
...
---@param EffectParam FPalCoopSkillSearchEffectParameter
function UBP_CoopSkillSearchEffectController_C:Start(EffectParam) end
