...
---@field Anm_Failed_Out UWidgetAnimation
---@field Anm_Failed_In UWidgetAnimation
---@field Anm_Saving UWidgetAnimation
---@field Canvas_AutoSave UCanvasPanel
---@field Canvas_SaveFailed UCanvasPanel
---@field Image_FailedBase UImage
---@field Image_FailedBase_1 UImage
---@field Image_FailedIcon UImage
...
---@field WaitFailedSaveDisplayTimer FTimerHandle
---@field FailedSaveNoticeDIsplayTime double
UWBP_AutoSave_C = {}

function UWBP_AutoSave_C:HideFailedSaveNotice() end
function UWBP_AutoSave_C:DisplayFailedSaveNotice() end
