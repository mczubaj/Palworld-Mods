...
---@field CreateSessionErrorMsgId_Console FDataTableRowHandle
---@field IsStartingGame boolean
UBP_PalGameInstance_C = {}

---@param Result boolean
function UBP_PalGameInstance_C:IsDeadInHardcore(Result) end
...
---@param World TSoftObjectPtr<UWorld>
function UBP_PalGameInstance_C:OverrideLoadMap(World) end
---@param bResult boolean
function UBP_PalGameInstance_C:OnPSNChatDisabled(bResult) end
