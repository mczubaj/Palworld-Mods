...
---@field BP_PalTextBlock_Crossplay UBP_PalTextBlock_C
...
function UWBP_InLevelLoadingFade_C:AnmEvent_FadeOut() end
function UWBP_InLevelLoadingFade_C:AnmEvent_FadeIn() end
