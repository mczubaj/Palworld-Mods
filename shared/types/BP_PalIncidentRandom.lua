...
---@field MapObjectSpawner APalRandomIncidentMapObjectSpawner
...
function UBP_PalIncidentRandom_C:CreateMapObjectSpawner() end
---@param InName FName
function UBP_PalIncidentRandom_C:ShowErrorNameDuplication(InName) end
...
function UBP_PalIncidentRandom_C:OnCanceled() end
