...
---@field TitleMsgIdPS5 FDataTableRowHandle
---@field CommandMsgId FDataTableRowHandle
---@field CommandMsgIdPS5 FDataTableRowHandle
---@field ErrorMsgId FDataTableRowHandle
---@field ErrorMsgIdPS5 FDataTableRowHandle
...
---@return FEventReply
function UWBP_OptionSettingsOverLayWindow_C:OnMouseButtonDown(MyGeometry, MouseEvent) end
---@param NewKey FKey
