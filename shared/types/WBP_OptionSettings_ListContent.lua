...
---@param UIActionName FName
---@param InputType ECommonInputType
---@param Key FKey
function UWBP_OptionSettings_ListContent_C:SetUIConfigButton(UIActionName, InputType, Key) end
---@param rowHandle FDataTableRowHandle
function UWBP_OptionSettings_ListContent_C:SetMsgId(rowHandle) end
function UWBP_OptionSettings_ListContent_C:Destruct() end
UWBP_OptionSettings_ListContent_C['カスタムイベント'] = function() end
