...
---@param IsOverrideRotation boolean
---@param Rotation FRotator
function ABP_BossBattle_BossCharacterSpawner_C:RequestOtherSpawn(CharacterID, Level, AIController, IsOutAreaSpawn, IsOverrideRotation, Rotation) end
