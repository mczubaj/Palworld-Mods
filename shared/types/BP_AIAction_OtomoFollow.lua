...
function UBP_AIAction_OtomoFollow_C:UpdateReturnTooFar() end
---@param IsTurn boolean
function UBP_AIAction_OtomoFollow_C:IsTurnInBuildingMode(IsTurn) end
---@param IsBuilding boolean
function UBP_AIAction_OtomoFollow_C:IsBuildingMode(IsBuilding) end
---@param Location FVector
function UBP_AIAction_OtomoFollow_C:GetTargetLocationInBuildingMode(Location) end
