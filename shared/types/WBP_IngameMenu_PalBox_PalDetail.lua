...
---@param IsTip boolean
function UWBP_IngameMenu_PalBox_PalDetail_C:SetDetailMode(IsTip) end
function UWBP_IngameMenu_PalBox_PalDetail_C:UpdateTalentBinded() end
function UWBP_IngameMenu_PalBox_PalDetail_C:UpdateFavoriteBinded() end
UWBP_IngameMenu_PalBox_PalDetail_C['Update Buff Binded'] = function() end
