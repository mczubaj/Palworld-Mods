...
---@field HorizontalBoxListSort UHorizontalBox
---@field HorizontalBoxPassword UHorizontalBox
...
---@field IgnoreVersionBox UHorizontalBox
---@field Image_43 UImage
---@field Overlay_OpenDirectory UOverlay
---@field PalEditableTextBox_IP UPalEditableTextBox
---@field PalEditableTextBox_Search UPalEditableTextBox
---@field PasswordCheckbox_1 UCheckBox
...
---@field WBP_PreviousButton UWBP_GuildHeadButton_C
...
---@field WBP_Title_SettingsButtonBackupSelect UWBP_Title_SettingsButton_C
...
---@field ['World Directory Name'] TMap<FString, UWBP_Title_WorldSelect_ListContent_C>
---@field OnClickedSelectBackupButton FWBP_Title_WorldSelect_COnClickedSelectBackupButton
---@field ServerPreviousButtonMsgID FDataTableRowHandle
...
---@param Navigation EUINavigation
---@return UWidget
function UWBP_Title_WorldSelect_C:CustomNavi_ToLeftListBottom(Navigation) end
---@param Navigation EUINavigation
---@return UWidget
function UWBP_Title_WorldSelect_C:CustomNavi_LeftListTop(Navigation) end
---@param Navigation EUINavigation
---@return UWidget
function UWBP_Title_WorldSelect_C:CustomNavi_ToListSetting(Navigation) end
---@param WorldPathName FString
---@param DisplayData FPalUILocalWorldDisplayData
UWBP_Title_WorldSelect_C['Update Local World List Content'] = function(WorldPathName, DisplayData) end
...
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_WBP_PreviousButton_K2Node_ComponentBoundEvent_6_OnClickedSingleButton__DelegateSignature() end
...
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_WBP_Title_SettingsButtonBackupSelect_K2Node_ComponentBoundEvent_7_OnClicked__DelegateSignature() end
---@param EntryPoint int32
function UWBP_Title_WorldSelect_C:ExecuteUbergraph_WBP_Title_WorldSelect(EntryPoint) end
function UWBP_Title_WorldSelect_C:OnClickedServerList_PreviousButton__DelegateSignature() end
---@param SelectedWorldButton UWBP_Title_WorldSelect_ListContent_C
function UWBP_Title_WorldSelect_C:OnClickedSelectBackupButton__DelegateSignature(SelectedWorldButton) end
---@param SelectedWorldButton UWBP_Title_WorldSelect_ListContent_C
