...
---@field PlatformID FPocketpairPlatformID
...
---@field ItemId int32
---@field Num int32
---@field Token TArray<uint8>
FPocketpairInventoryItem = {}



---@class FPocketpairPlatformID
---@field AccountID uint32
---@field AccountInstance uint32
---@field Universe int32
---@field AccountType int32
