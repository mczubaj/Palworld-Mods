...
---@field Text_Difficulty_HardCore UBP_PalTextBlock_C
---@field Text_MultiPlay_LocalWorld UBP_PalTextBlock_C
...
---@param HostName FString
---@param TimeMS int32
function UWBP_Title_WorldSelect_ListContent_C:OnPingComplete(PingOperation, HostName, TimeMS) end
