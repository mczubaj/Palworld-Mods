...
---@field WBP_OptionSettings_Common_HideCraftExpLog UWBP_OptionSettings_ListContent_C
...
---@field WBP_OptionSettings_GP_ToggleBuildMode UWBP_OptionSettings_ListContent_C
...
---@field WBP_OptionSettings_ToggleBuildMode UWBP_OptionSettings_ListContent_C
...
---@field WBP_OptionSettings_UI_HideUINotInBattle UWBP_OptionSettings_ListContent_C
---@field WBP_OptionSettings_UI_MaxDamageDisplayNum UWBP_OptionSettings_ListContent_C
---@field WBP_OptionSettings_UI_MinFontSize UWBP_OptionSettings_ListContent_C
...
---@field FontSizeSelections TArray<FDataTableRowHandle>
---@field FontSizeMap TMap<int32, int32>
...
---@param Value int32
function UWBP_Control_Settings_C:OnMinFontSizeChanged(Value) end
---@param IsOn boolean
function UWBP_Control_Settings_C:OnToggleBuildModeChanged(IsOn) end
---@param IsOn boolean
function UWBP_Control_Settings_C:OnToggleBuildModeChanged_GP(IsOn) end
---@param IsOn boolean
function UWBP_Control_Settings_C:OnChangedHideCraftExpLog(IsOn) end
---@param IsOn boolean
function UWBP_Control_Settings_C:OnChangedHideUINotInBattle(IsOn) end
