...
---@field FadeOutParameter UPalHUDDispatchParameter_FadeWidget
---@field DefaultHeadCameraLocation FVector
---@field DefaultBodyCameraLocation FVector
---@field ToggleEquipDisplayInputAction FPalDataTableRowName_UIInputAction
...
---@field IsCachingMakeData boolean
---@field CharacterMakeData UBP_PalPlayerDataCharacterMake_C
---@field flagName FName
---@field NowDisplayEquip boolean
...
function UWBP_CharacterMake_C:OnEndLoadingFadeOut() end
---@param CategoryType E_UICharacterMakeCategory::Type
...
function UWBP_CharacterMake_C:BndEvt__WBP_CharacterMake_WBP_CharaCre_K2Node_ComponentBoundEvent_20_OnClickedInGameCompleteButton__DelegateSignature() end
function UWBP_CharacterMake_C:Destruct() end
