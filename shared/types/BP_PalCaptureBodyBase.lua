...
---@field IsCriticalCapture boolean
ABP_PalCaptureBodyBase_C = {}

---@param NewParam int32
function ABP_PalCaptureBodyBase_C:GetCriticalCaptureLevel(NewParam) end
---@param bCritical boolean
function ABP_PalCaptureBodyBase_C:SetCriticalFlag(bCritical) end
...
---@param Level int32
function ABP_PalCaptureBodyBase_C:SetCaptureLevelInternal(Level) end
---@param isSneak boolean
function ABP_PalCaptureBodyBase_C:SetSneakBonusFlagInternal(isSneak) end
---@param TargetCharacter APalCharacter
function ABP_PalCaptureBodyBase_C:SetupInternal(TargetCharacter) end
---@param bIsCritical boolean
function ABP_PalCaptureBodyBase_C:SetCriticalCaptureFlagInternal(bIsCritical) end
