...
UWBP_PalSaveParameterDisplayWidget_C['Bind Event'] = function() end
...
function UWBP_PalSaveParameterDisplayWidget_C:SetFavorite(IsFavorite) end
...
UWBP_PalSaveParameterDisplayWidget_C['Calc HP'] = function() end
---@param nowHP int32
---@param MaxHP int32
