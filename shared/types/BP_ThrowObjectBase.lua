...
---@field IsCachedGravityScale boolean
ABP_ThrowObjectBase_C = {}

function ABP_ThrowObjectBase_C:CacheDefaultGravity() end
...
---@param OtherComp UPrimitiveComponent
---@param Hit FHitResult
function ABP_ThrowObjectBase_C:OnHit(HitComp, OtherActor, OtherComp, Hit) end
