...
---@field Anm_DefaultToRed UWidgetAnimation
...
function UWBP_CommonButton_C:SetDefaultText() end
...
function UWBP_CommonButton_C:AnmEvent_Default() end
function UWBP_CommonButton_C:AnmEvent_Red() end
