...
function ABP_WantedPolice_NPCSpawner_C:FinderChangeAction(Reporter, WantedPlayer, Organization) end
function ABP_WantedPolice_NPCSpawner_C:CheckWanted() end
