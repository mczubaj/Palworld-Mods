...
---@field Const_DownRayDistance double
UBP_AIAction_NPC_CombatBase_C = {}

---@param Location FVector
function UBP_AIAction_NPC_CombatBase_C:RayCheckToGround(Location) end
---@param OnSea boolean
function UBP_AIAction_NPC_CombatBase_C:IsTargetOnSea(OnSea) end
---@param Alive boolean
