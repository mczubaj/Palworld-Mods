...
---@field Text_Durable_Slash UBP_PalTextBlock_C
---@field Text_DurableNum_Max UBP_PalTextBlock_C
---@field Text_DurableNum_Now UBP_PalTextBlock_C
...
---@param Text FText
function UWBP_InventoryEquipment_ItemInfo_C:OverrideNumCountText(Text) end
---@param ItemData UPalStaticItemDataBase
---@param outName FText
function UWBP_InventoryEquipment_ItemInfo_C:GetItemCategoryName(ItemData, outName) end
---@param ItemData UPalStaticItemDataBase
---@param Name FText
function UWBP_InventoryEquipment_ItemInfo_C:GetFoodCategoryName(ItemData, Name) end
---@param ItemAndNum FPalItemAndNum
function UWBP_InventoryEquipment_ItemInfo_C:SetupByItemAndNum(ItemAndNum) end
...
function UWBP_InventoryEquipment_ItemInfo_C:SetupItemRarity(StaticItemId) end
...
function UWBP_InventoryEquipment_ItemInfo_C:SetupUseableKeyGuide_Internal() end
---@param ItemStaticId FName
function UWBP_InventoryEquipment_ItemInfo_C:SetupSkillInfo(ItemStaticId) end
...
---@param StaticItemId FName
function UWBP_InventoryEquipment_ItemInfo_C:SetupItemDescription(StaticItemId) end
---@param ItemStaticId FName
UWBP_InventoryEquipment_ItemInfo_C['Setup Item Name'] = function(ItemStaticId) end
---@param ItemId FName
