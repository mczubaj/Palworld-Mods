...
---@param Target AActor
function UBP_AIAction_OtomoDefault_C:FindTrainerBattleEnemy(Target) end
---@param Target AActor
UBP_AIAction_OtomoDefault_C['Set Action Berserker'] = function(Target) end
...
---@param Target AActor
function UBP_AIAction_OtomoDefault_C:SetOtomoBerserker(Target) end
