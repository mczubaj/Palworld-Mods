...
---@field ItemShopHUDParameter UPalHUDDispatchParameter_ItemShop
...
---@field TalkUIID FGuid
---@field ItemShopUIID FGuid
---@field PalShopUIID FGuid
---@field CustomFunctionNames TArray<FName>
UBP_PalIncidentNPCTalk_C = {}

---@param RecordMap TMap<FName, boolean>
---@param RequestData TArray<FPalCircumRequestData>
---@param RequestCategory EPalItemRequireCategory
---@param CircumCountMap TMap<FString, int32>
---@param Index int32
---@param EnalbeExpBonus boolean
function UBP_PalIncidentNPCTalk_C:GetValidItemRequestIndex(RecordMap, RequestData, RequestCategory, CircumCountMap, Index, EnalbeExpBonus) end
---@param RecordMap TMap<FName, boolean>
---@param RewardData TArray<FPalDisplayRequestData>
---@param RequestCategory EPalPalDisplayCategory
---@param Index int32
function UBP_PalIncidentNPCTalk_C:GetValidPalDisplayIndex(RecordMap, RewardData, RequestCategory, Index) end
---@param RecordMap TMap<FName, boolean>
---@param RewardData TArray<FPalRecordCountRewardData>
---@param Index int32
function UBP_PalIncidentNPCTalk_C:GetValidRewardCountIndex(RecordMap, RewardData, Index) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CheckEmote(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:AchivementReward(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CheckPalCapture(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CheckBossDefeat(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CheckPalDex(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CheckDisplayPal(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:PalDisplayRequest(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CircumItemTrade(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CircumItemRequest(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Doctor CheckDayLimit'] = function(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Doctor Check Otomo'] = function(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Doctor Surgi Fail'] = function(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Doctor Surgi Success'] = function(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Doctor Surgi Random'] = function(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:VisitorPresentAndReturn(Param) end
---@param CustomEventName FName
---@return boolean
function UBP_PalIncidentNPCTalk_C:IsExistCustomEvent(CustomEventName) end
---@param CustomEventName FName
---@param Parameter FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:OnCustomEvent(CustomEventName, Parameter) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:CustomFunctionToServer(Param) end
...
UBP_PalIncidentNPCTalk_C['On Talk Character Captured'] = function() end
---@param Info FPalDeadInfo
function UBP_PalIncidentNPCTalk_C:OnTalkCharacterDead(Info) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Cunsume Request Item'] = function(Param) end
...
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Attack to Player'] = function(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
...
UBP_PalIncidentNPCTalk_C['Set Disable Movement For Target'] = function(isDisable) end
...
---@param Param FPalNPCTalkSystemCustomFunctionParameters
UBP_PalIncidentNPCTalk_C['Open Item Shop Buy'] = function(Param) end
---@param Param FPalNPCTalkSystemCustomFunctionParameters
...
---@param HUDParam UPalHUDDispatchParameter_ItemShop
...
---@param Param FPalNPCTalkSystemCustomFunctionParameters
function UBP_PalIncidentNPCTalk_C:OpenRecruitUI(Param) end
---@param Param UPalHUDDispatchParameterBase
function UBP_PalIncidentNPCTalk_C:OnCloseRecruitUI(Param) end
function UBP_PalIncidentNPCTalk_C:OnRecruit() end
