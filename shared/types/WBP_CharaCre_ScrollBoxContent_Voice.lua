...
---@field OnHoveredVoiceButton FWBP_CharaCre_ScrollBoxContent_Voice_COnHoveredVoiceButton
---@field OnUnhoveredVoiceButton FWBP_CharaCre_ScrollBoxContent_Voice_COnUnhoveredVoiceButton
UWBP_CharaCre_ScrollBoxContent_Voice_C = {}

function UWBP_CharaCre_ScrollBoxContent_Voice_C:OnUnhoveredVoiceTypeButton() end
---@param Widget UWBP_CharaCre_BodyTypeButton_C
function UWBP_CharaCre_ScrollBoxContent_Voice_C:OnHoveredVoiceTypeButton(Widget) end
---@param Widget UWBP_CharaCre_BodyTypeButton_C
...
function UWBP_CharaCre_ScrollBoxContent_Voice_C:OnUnhoveredVoiceButton__DelegateSignature() end
---@param VoiceID int32
function UWBP_CharaCre_ScrollBoxContent_Voice_C:OnHoveredVoiceButton__DelegateSignature(VoiceID) end
---@param VoiceID int32
